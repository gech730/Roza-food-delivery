  ...
  return (
    <div className='cart-page'>
      <div className="cart-page-header">
        <h1>Your Cart</h1>
        <p>{cartFoods.length} {cartFoods.length !== 1 ? 'items' : 'item'}</p>
      </div>
      ...
      {cartFoods.length === 0 ? (
        <div className="cart-empty">
          ...
          <p>Browse our menu and add Ethiopian dishes you would like to order.</p>
        ...
        <div className="cart-layout">
          ...
          <div className="cart-summary">
            ...
            <div className="cart-summary-rows">
              ...
              <div className="cart-summary-row"><span>Delivery</span><span>{delivery} ETB</span></div>
              <div className="cart-summary-row total"><span>Total</span><span>{subtotal + delivery} ETB</span></div>
            </div>

            <div className="cart-promo">
              <input type="text" placeholder="Promo code (if any)" />
              <button>Apply</button>
            </div>
